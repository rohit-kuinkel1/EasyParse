...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        private JaroWinklerSimilarity _similarity;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        public void Calculate_StringsWithCommonPrefix_ReturnsHigherScore()
        {
            ...
            Assert.That( result, Is.GreaterThan( resultReversed ),
        ...
        public void Calculate_CaseSensitiveComparison()
        {
            ...
            Assert.That( result, Is.LessThan( 1.0 ),
                "Case-sensitive comparison should not consider different cased strings as identical" );
        }
        ...
        public void Calculate_StringsWithNumbers()
        {
            ...
            Assert.That( result, Is.GreaterThan( 0.8 ),
                "Numbers should be handled properly" );
        }
        ...
        public void Calculate_StringsWithSpaces()
        {
            ...
            Assert.That( result, Is.GreaterThan( 0.9 ),
                "Spaces should be handled properly" );
        }
