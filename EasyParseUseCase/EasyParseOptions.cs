...
namespace Program
{
    ...
    /// Whatever the name, you need to provide it as a generic argument to <see cref="EasyParse.EasyParser.Parse{T}(string[])"/>.
    ...
    /// The enums <see cref="EasyParse.Enums.MutualType"/> can be used to denote a 
    /// <see cref="EasyParse.Enums.MutualType.Exclusive"/> or 
    /// <see cref="EasyParse.Enums.MutualType.Inclusive"/> relationship between two <see cref="OptionsAttribute"/>.
    ...
    /// limited to [0,20]. If the user provided value does not lie in the defined range, then the parsing was not successful and <see cref="EasyParse.EasyParser.Parse{T}(string[])"/>
    ...
    public class ParseVerbs
    {
        ...
        [Mutual(EasyParse.Enums.MutualType.Inclusive, nameof(Verbose), nameof(Stdin))]
    ...
    public class VideoProcessVerbs
    {
        ...
        [Mutual( EasyParse.Enums.MutualType.Inclusive, nameof( Quality ), nameof( Duration ) )]
    ...
    public class DatabaseBackupVerbs
    {
        ...
        [Mutual( EasyParse.Enums.MutualType.Inclusive, nameof( Port ), nameof( Compress ) )]
        ...
        [Mutual( EasyParse.Enums.MutualType.Inclusive, nameof( Compress ) )]
    ...
    public class WeatherStationVerbs
    {
        ...
        [Mutual( EasyParse.Enums.MutualType.Inclusive, nameof( Interval ), nameof( Units ) )]
